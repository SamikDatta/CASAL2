...
\paragraph{Instantaneous mortality retained}\label{sec:inst-mort-retained}

The instantaneous mortality retained process\index{Instantaneous mortality retained} is the same as the instantaneous mortality process, but allows both total and retained catch to be accounted for. For this an additional selectivity \texttt{retained\_selectivity} needs to be provided as part of the process, such as in the example below:


{\small{\begin{verbatim}
@process Instantaneous_Mortality_Retained
type mortality_instantaneous_retained  #Instantaneous_Mortality_Retained
m 0    # testing without natural mortality
time_step_ratio 1
selectivities One
categories *
table catches
