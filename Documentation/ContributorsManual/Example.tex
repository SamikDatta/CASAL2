...
\begin{enumerate}
	...
	\item Add the process into the file \path{Translations\English_UK.h}, as follows: \texttt{\# define PARAM\_SURVIVAL\_CONSTANT\_RATE} \texttt{"survival\_constant\_rate"}	
\end{enumerate}
